        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Create multiple branches for Git-like branching for different
              opportunities
            </p>
          </div>
          ...
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Access expertly designed templates that make your documents stand
              out
            </p>
          </div>
          ...
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed">
              Never lose progress. Track all changes and revert to any previous
              version
            </p>
          </div>
        </div>
